...
- `docs/agent/architecture.md` - Main documentation file to be created/updated with architectural diagrams
...
- [ ] 1.0 Commit or stash current changes
  - [ ] 1.1 Check git status for uncommitted changes
  - [ ] 1.2 Commit current changes to the `tests` branch or stash them
- [ ] 2.0 Analyze codebase structure and components
  - [ ] 2.1 Read src/models/models.py to understand database models
  - [ ] 2.2 Read src/scraper/auction_collector.py to understand auction collection
  - [ ] 2.3 Read src/scraper/scraper.py to understand main scraper service
  - [ ] 2.4 Read repository files (auction_repository_eu.py, auction_repository_us.py, recipe_repository.py, reagent_repository.py)
  - [ ] 2.5 Read seeding files (recipes.py, reagents.py) to understand seeding logic
  - [ ] 2.6 Read src/main.py to understand service orchestration
  - [ ] 2.7 Document key components and their relationships
- [ ] 3.0 Create high-level system architecture diagram
  - [ ] 3.1 Create Mermaid flowchart showing Scheduler Service, PostgreSQL, and API Service
  - [ ] 3.2 Add connections between services
  - [ ] 3.3 Add notes explaining each service's role
  - [ ] 3.4 Add the diagram to docs/agent/architecture.md
- [ ] 4.0 Create data flow diagram
  ...
  - [ ] 4.4 Add the diagram to docs/agent/architecture.md
- [ ] 5.0 Create component interaction diagrams
  ...
  - [ ] 5.4 Add the diagrams to docs/agent/architecture.md
- [ ] 6.0 Create data model overview diagram
  ...
  - [ ] 6.4 Add the diagrams to docs/agent/architecture.md
- [ ] 7.0 Create sequence diagrams for critical operations
  ...
  - [ ] 7.5 Add the diagrams to docs/agent/architecture.md
